...
without using Tauri APIs or host DOM access. Host appearance tokens are applied
before plugin script runs (`appearance@1`); Ink Tools chrome uses those CSS
variables. It also reads a small project
