...
mod tests {
    ...
    fn synthetic_climate(field: &PhysicalField, runoff_mm_per_year: u32) -> ClimateField {
        ...
        ClimateField {
            ...
            wind_east_milli: vec![0; sample_count],
            wind_north_milli: vec![0; sample_count],
            wind_east_nh_summer_milli: vec![0; sample_count],
            wind_north_nh_summer_milli: vec![0; sample_count],
            wind_east_nh_winter_milli: vec![0; sample_count],
            wind_north_nh_winter_milli: vec![0; sample_count],
            wind_divergence_ppm: vec![0; sample_count],
            wind_divergence_nh_summer_ppm: vec![0; sample_count],
            wind_divergence_nh_winter_ppm: vec![0; sample_count],
            ...
            metrics: crate::climate::ClimateMetrics::default(),
        }
    }
