...
export interface FieldDefinition { cardinality?: "one" | "many"; entityTypes?: string[]; key: string; label: string; metadataFields?: MetadataFieldDefinition[]; multiple?: boolean; oneOf?: OneOfVariant[]; options?: string[] | null; relationshipConstraints?: RelationshipConstraints; relationshipDirection?: "outgoing" | "incoming" | "undirected"; relationshipType?: string; required?: boolean | null; shared?: boolean; targetEntityTypes?: string[]; timeline?: TimelineFieldContribution; type: FieldType }
...
export interface ImporterContribution { description: string; extensions: string[]; id: string; mimeTypes?: string[]; name: string; sourceKinds: string[]; version: string }
