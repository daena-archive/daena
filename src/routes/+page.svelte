<script lang="ts">
  ...
  function hasCreateValues() {
    const hasNonDropdownValues = createFieldsFor().some(({ field }) => !isCreateDropdownField(field) && isCreateValuePopulated(createFieldValues[field.key]));
  ...
  function entityGlyph(entity: Pick<Entity, "entity_type">) {
    return entity.entity_type === "person" ? "P" : entity.entity_type === "place" ? "L" : entity.entity_type === "faction" ? "F" : entity.entity_type === "artifact" ? "A" : entity.entity_type === "culture" ? "C" : entity.entity_type === "concept" ? "◇" : entity.entity_type === "event" ? "E" : entity.entity_type === "manuscript" ? "M" : entity.entity_type === "reference-page" ? "R" : "?";
  }
                      ...
                      <section class="plugin-detail-section">
                        ...
                        <ul class="plugin-detail-list">
                          {#each plugin.capabilities as capability}
                            ...
                            <li class:granted={granted} class="capability-row"><span class="capability-name">{capabilityLabel(capability)}</span><span class="cap-mark">{granted ? "✓" : "—"}</span></li>
                          {/each}
                        </ul>
                      </section>
                      <section class="plugin-detail-section">
...
<style>
  ...
  .map-toolbar-actions { margin-left: auto; display: flex; gap: 6px; }
  ...
  .plugin-detail-list li.capability-row { display: flex; align-items: flex-start; gap: 8px; min-width: 0; }
  .capability-name { min-width: 0; overflow-wrap: anywhere; }
  ...
  .cap-mark { flex: 0 0 auto; margin-left: auto; color: var(--ink-faint); }
