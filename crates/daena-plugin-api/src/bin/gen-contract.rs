...
use daena_plugin_api::rpc::{
    AiRequestIdPayload, AiRequestStartPayload, AppVersionPayload, AppearanceGetPayload,
    AssetDeletePayload, AssetListPayload, AssetMetadataUpdatePayload, AssetReadBeginPayload,
    ...
    EntityGetManyPayload, EntityGetPayload, EntityListPayload, EntityPageRecord,
    EntityQueryPayload, EntityRecord, EntityTypeCountRecord, EntityUpdatePayload,
    EventPublishPayload, EventTypePayload, FieldListPayload, FieldReadPayload, FieldSetPayload,
    ...
    RelationshipPageRecord, RelationshipQueryPayload, RelationshipUpdatePayload,
...
fn register_payload(gen: &mut SchemaGenerator, payload_schema: &str) {
    let _ = match payload_schema {
        ...
        "AssetMetadataUpdatePayload" => gen.subschema_for::<AssetMetadataUpdatePayload>(),
        "AssetDeletePayload" => gen.subschema_for::<AssetDeletePayload>(),
        ...
        "MapsImageImportBeginPayload" => gen.subschema_for::<MapsImageImportBeginPayload>(),
        "MapsImageImportCommitPayload" => gen.subschema_for::<MapsImageImportCommitPayload>(),
        "MapsVectorCreateBeginPayload" => gen.subschema_for::<MapsVectorCreateBeginPayload>(),
        "MapsVectorCreateCommitPayload" => gen.subschema_for::<MapsVectorCreateCommitPayload>(),
        "MapsPhysicalCreateBeginPayload" => gen.subschema_for::<MapsPhysicalCreateBeginPayload>(),
        "MapsPhysicalCreateCommitPayload" => gen.subschema_for::<MapsPhysicalCreateCommitPayload>(),
        "MapsVectorReplaceBeginPayload" => gen.subschema_for::<MapsVectorReplaceBeginPayload>(),
        "MapsVectorReplaceCommitPayload" => gen.subschema_for::<MapsVectorReplaceCommitPayload>(),
        "MapsLayerCreatePayload" => gen.subschema_for::<MapsLayerCreatePayload>(),
        "MapsLayerDeletePayload" => gen.subschema_for::<MapsLayerDeletePayload>(),
        "MapsLayerUpdatePayload" => gen.subschema_for::<MapsLayerUpdatePayload>(),
        ...
        "AppearanceGetPayload" => gen.subschema_for::<AppearanceGetPayload>(),
