import type { WorldbuilderModule } from "../../../packages/module-api/src/index";
...
const projectionModules: Record<ProjectionModuleId, { title: string; module: WorldbuilderModule }> = {
